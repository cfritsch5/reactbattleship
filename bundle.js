...
var _battleship = __webpack_require__(28);
...
var Game = function (_React$Component) {
  ...
  _createClass(Game, [{
    ...
    value: function placePlayer(player) {
      var active = this.state.game.currentPlayer !== player ? 'active' : 'inactive';
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_board2.default, { attack: this.attack, board: player.grid })
      );
    }
  }, {
    key: 'render',
...
function validsquare(row, col, size) {
  ...
  var upperbound = row < size && col < size;
...
var Board = function (_React$Component) {
  ...
  _createClass(Board, [{
    ...
    value: function generateBoard() {
      ...
      var indexY = 0;
      return this.props.board.map(function (row) {
        var squares = _this2.generateSquares(row, indexY);
        indexY++;
        return _react2.default.createElement(
          'ul',
          { key: indexY },
    ...
    key: 'generateSquares',
    value: function generateSquares(row, indexY) {
      var _this3 = this;

      var cssClassName = void 0,
          indexX = -1; // shortcut way around off by one
      return row.map(function (square) {
        ...
        return _react2.default.createElement(_square2.default, { key: indexX,
          'class': cssClassName,
          col: indexX, row: indexY,
          attack: _this3.props.attack });
      });
    }
  }, {
    key: 'render',
    ...
    value: function render() {
      ...
      return _react2.default.createElement('li', {
        ...
        onClick: function onClick() {
          return _this2.props.attack(_this2.props.row, _this2.props.col);
        } });
    }
  }]);
